...
collisions dentro de una carpeta, solo funciona si tienes el archivo de la BD original
(switrs.sqlite)
"""

DB_PATH = "switrs.sqlite"
OUTPUT_DIR = "parquet_collisions"
...
for i, chunk in enumerate(
    ...
    output_file = f"{OUTPUT_DIR}/collisions_part_{i}.parquet"
